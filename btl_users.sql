...
CREATE TABLE `users` (
  ...
  `points` varchar(45) COLLATE latin1_bin NOT NULL,
...
INSERT INTO `users` VALUES (1,'tien','tien','123','12',2,0,0,0),(2,'tung','tung','123','1',2,0,0,0);
...
-- Dump completed on 2020-12-05 22:24:03
