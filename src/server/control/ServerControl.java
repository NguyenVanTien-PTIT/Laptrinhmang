...
public class ServerControl {
    ...
    public void updateOnlineUsers() {
        try {
            for (Map.Entry<String, Handler> x : useronline.entrySet()) {
                Handler value = x.getValue();
                ...
                try {
                    ...
                    if (rq.equals("log out")) {
                        ...
                        synchronized (lock) {
                            Users u2 = (Users) ois.readObject();
                            Users u1 = (Users) ois.readObject();
                            useronline.get(u1.getUsername()).getOos().writeUTF("not accept");
                            useronline.get(u1.getUsername()).getOos().writeObject(u2);
                        }
